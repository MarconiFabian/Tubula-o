...
import { INITIAL_PIPES, STATUS_COLORS } from './constants';
...
export default function App() {
  ...
  const getStatusColor = (status: PipeStatus) => {
      // Safety check in case STATUS_COLORS or status is undefined
      return (STATUS_COLORS && STATUS_COLORS[status]) ? STATUS_COLORS[status] : '#94a3b8';
  };
